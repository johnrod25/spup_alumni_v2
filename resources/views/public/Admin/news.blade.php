        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h3>Manage News</h3>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal-news"><i class="fa fa-plus"
                            aria-hidden="true"></i> Add News</button>
                </div>
                <hr class="hr">
                        ...
                        @foreach ($datas as $data)
                            <tr class="text-capitalize">
                                ...
                                <td class="d-flex justify-content-center"><img
                                        src="{{ asset('images/news/' . $data->image_path) }}" alt=""
