  ...
  <footer id="footer" class="container-fluid">
      ...
      <div class="footer-top bg-green container-fluid">
          <div class="container">
              <div class="row ">
                  <div class="col-lg-3 col-md-6 footer-contact">
                      <h3>St. Paul University Philippines</h3>
                      <p> Mabini Street, Tuguegarao City <br>
                          Cagayan, Philippines,3500<br><br>
                          <strong>Phone:</strong> 396-1987<br>
                          <strong>Email:</strong> spupadmin@spup.edu.ph<br>
                      </p>
                  </div>
                  ...
                  <div class="col-lg-3 col-md-6 footer-links">
                      ...
                      <p>Follow us to keep up with the latest updates from our school.</p>
      ...
      <div class="container py-4">
          <div class="copyright d-flex justify-content-center align-items-center text-dark">
              &copy; Copyright <strong><span class="mx-1">SPUP.</span></strong> All Rights Reserved
          </div>
